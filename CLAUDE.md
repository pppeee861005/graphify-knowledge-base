...
#### 6. **克勞德的細語** (`/claude-whisper` 或 `/克勞德細語`) ✅ 2026-06-XX 新增
- **Skill 名稱**：`claude-whisper`
- **版本**：v1.0.0
...
- **觸發條件**：用戶輸入 `/claude-whisper` 或 `/克勞德細語`，或需要創作「科幻 × 實踐」混合主題文章
- **關鍵文檔**：
  - `skills/claude-whisper/SKILL.md` — 完整風格指南與寫作技巧
...
| `/claude-whisper` ⭐ **AI蜂群投資專用** | 科幻股市商戰紀實的寫作風格驗證。大綱完成、初稿完成、發布前各調用一次，確保代入感、技術硬度、情感弧線達標。詳見「🎨 克勞德的細語 Skill 集成」章節 |
